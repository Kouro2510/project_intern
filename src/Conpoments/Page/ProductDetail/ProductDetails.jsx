        ...
        <div className="details">
            <div className="container-details">
                <div className="col-5 img-left">
                    <Carousel showArrows={true} autoPlay interval={10000} infiniteLoop>
                        <div>
                            <img src={Image.Test1} alt="/"/>
                        </div>
                        <div>
                            <img src={Image.Test2} alt="/"/>
                        </div>
                        <div>
                            <img src={Image.Test3} alt="/"/>
                        </div>
                        <div>
                            <img src={Image.Test4} alt="/"/>
                        </div>
                        <div>
                            <img src={Image.Test5} alt="/"/>
                        </div>
                    </Carousel>
